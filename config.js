...
module.exports = {
    ...
    DESCRIPTION:           process.env.DESCRIPTION || "𝘽​⊙𝙗 𝘽​⊙𝙩",
    ALIVE_IMG:             process.env.ALIVE_IMG || "https://files.catbox.moe/waa8nl.jpg",
    LIVE_MSG:              process.env.LIVE_MSG || "Bob Bot is active, based on what I know. ",
    ...
    STATUS_MSG:            process.env.STATUS_MSG    || 'Bob bot has succesfully seen your STATUS',
